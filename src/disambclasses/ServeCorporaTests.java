 ...
 * @author ana
 */
public class ServeCorporaTests implements Runnable{

     private static int[] senses = {1, 2, 4, 5, 6};
    private static String[] files = {"serve10", "serve12", "serve2", "serve6"};
    ...
    public String[] parseOriginalServe(String text)
    {
        String[] contexts;
    ...
    public void setNormalize (boolean normalize)
    {
     ...
     public int[] testServeCorpusFromFile(String file)
    {
        String[] contexts = parseOriginalServe(getAsString(file));
        ...
        String targetWord = "serve";
        String alternativeForms[] = {"service", "services"};   //??
      //  disambiguator.setAlternativeForms(alternativeForms);
        ...
        for (int i = 0; i < contexts.length; i++)
        {
            ...
            disambiguator.setParameters(targetWord, SynsetType.VERB, contexts[i], window, candidateGroups);
    ...
    public int[] testLineCorpusFromAll()
    {
        ...
        for (int f = 0; f < files.length; f++)
        {
            ...
            interres = testServeCorpusFromFile(files[f]);
            result[i++] = interres[0];
            result[i++] = interres[1];
